...
{
  accel_angle = atan2f((float)-accel_t_gyro.value.x_accel, (float)accel_t_gyro.value.z_accel) * RAD2GRAD;
  y_gyro_value = (accel_t_gyro.value.y_gyro - y_gyro_offset) / 65.5; // Accel scale at 500deg/seg  => 65.5 LSB/deg/s
